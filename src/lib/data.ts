...
export const webDemoItems: CardStackItem[] = [
  {
    ...
    description: "Live AI-powered reservation system with conversational booking.",
    href: "https://www.wikipedia.org",
    imageSrc: screenshotUrl("https://www.wikipedia.org"),
  },
  {
    id: 2,
    title: "Demo Support",
    description: "Handling order inquiries, refunds, and upselling.",
    href: "https://yallaviral.com",
    imageSrc: screenshotUrl("https://yallaviral.com"),
  },
  {
    id: 3,
    title: "Real Estate Lead Gen Demo",
    description: "Outbound AI calling for property showing scheduling.",
    href: "https://developer.mozilla.org",
    imageSrc: screenshotUrl("https://developer.mozilla.org"),
  },
  {
    id: 4,
    title: "Healthcare Intake Demo",
    description: "Automated patient intake and appointment scheduling via voice AI.",
    href: "https://www.bing.com",
    imageSrc: screenshotUrl("https://www.bing.com"),
  },
  {
    id: 5,
    title: "Auto Dealership Demo",
    description: "Follow-up AI agent booking test drives 24/7.",
    href: "https://duckduckgo.com",
    imageSrc: screenshotUrl("https://duckduckgo.com"),
  },
];