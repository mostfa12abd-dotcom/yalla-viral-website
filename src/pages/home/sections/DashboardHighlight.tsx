        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              {[
                { num: "01", title: "Speak to AI", desc: "Call our assistant. Book an appointment or ask any question." },
                { num: "02", title: "Get a demo", desc: "Experience our AI voice agent in real time — it's the best way to see it." },
                { num: "03", title: "Walk away booked", desc: "You'll have a confirmed consultation and firsthand proof of what AI can do." },
              ].map((step, i) => (
                <div key={i} className="text-center">
                  <div className="w-8 h-8 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center text-xs font-bold text-primary mx-auto mb-2">
                    {step.num}
                  </div>
