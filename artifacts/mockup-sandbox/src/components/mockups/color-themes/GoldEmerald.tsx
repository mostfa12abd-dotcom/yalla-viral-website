  ...
  return (
    <div style={{ background: "#0A0F1E", minHeight: "100vh", fontFamily: "'Inter', sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <style>{`
        ...
        .btn-blue { background: linear-gradient(135deg,#3B82F6,#2563EB); transition: opacity .2s; }
      ...
      <div style={{ position: "relative", zIndex: 10, textAlign: "center", padding: "72px 48px 48px" }}>
        {/* Badge — GOLD accent */}
        <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(245,158,11,0.12)", border: "1px solid rgba(245,158,11,0.35)", borderRadius: 999, padding: "6px 16px", marginBottom: 32 }}>
          <span style={{ width: 7, height: 7, borderRadius: "50%", background: "#F59E0B", display: "inline-block" }} />
          <span style={{ color: "#F59E0B", fontSize: 13, fontWeight: 500 }}>New: Multilingual AI Voice Agents</span>
        </div>

        {/* Headline — blue stays primary, gold on key word */}
        <h1 style={{ fontSize: 64, fontWeight: 800, lineHeight: 1.1, color: "#fff", margin: "0 0 24px", maxWidth: 800, marginLeft: "auto", marginRight: "auto" }}>
          ...
          <span style={{ color: "#F59E0B" }}>Answer Calls</span> &amp; Grow Revenue
        </h1>
        ...
        {/* CTA — BLUE (unchanged) */}
        <button className="btn-blue glow-blue" style={{ color: "#fff", border: "none", padding: "16px 36px", borderRadius: 999, fontSize: 16, fontWeight: 600, cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 8 }}>
          Get Your Free AI Growth Audit →
        </button>
        <p style={{ color: "#64748B", fontSize: 13, marginTop: 12 }}>No credit card required. 100% Free.</p>
      </div>

      {/* Stat cards — blue / gold / emerald each different */}
      <div style={{ position: "relative", zIndex: 10, display: "flex", gap: 20, justifyContent: "center", padding: "0 48px 64px" }}>
        {[
          ...
          { num: "24/7", label: "AI Coverage", accent: "#F59E0B" },
          { num: "3×", label: "Faster Growth", accent: "#10B981" },
